...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.AmazonStore = {}));
  ...
  function label(code){ return `Amazon ${STORES[code]?.name || "UK"}`; }

  function url(asin, opts={}){
  ...
  exports.default = amazonStore_esm;
  exports.detectRegion = detectRegion;
  exports.enhance = enhance;
  exports.enhanceAll = enhanceAll;
  exports.label = label;
  exports.renderStoreGrid = renderStoreGrid;
  exports.renderStoreGridAll = renderStoreGridAll;
  exports.url = url;
